...
/**
 * This class defines the structure of the 'login_session' table.
 *
 *
 *
...
class LoginSessionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.LoginSessionTableMap';
     ...
     */
    const TABLE_NAME = 'login_session';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\LoginSession';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'LoginSession';
     ...
     */
    const COL_ID = 'login_session.id';

    /**
     * the column name for the user_type field
     */
    const COL_USER_TYPE = 'login_session.user_type';

    /**
     * the column name for the user_id field
     */
    const COL_USER_ID = 'login_session.user_id';

    /**
     * the column name for the session_id field
     */
    const COL_SESSION_ID = 'login_session.session_id';

    /**
     * the column name for the session_key field
     */
    const COL_SESSION_KEY = 'login_session.session_key';

    /**
     * the column name for the disabled field
     */
    const COL_DISABLED = 'login_session.disabled';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'login_session.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'login_session.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'UserType', 'UserId', 'SessionId', 'SessionKey', 'Disabled', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'userType', 'userId', 'sessionId', 'sessionKey', 'disabled', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(LoginSessionTableMap::COL_ID, LoginSessionTableMap::COL_USER_TYPE, LoginSessionTableMap::COL_USER_ID, LoginSessionTableMap::COL_SESSION_ID, LoginSessionTableMap::COL_SESSION_KEY, LoginSessionTableMap::COL_DISABLED, LoginSessionTableMap::COL_CREATED_AT, LoginSessionTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'user_type', 'user_id', 'session_id', 'session_key', 'disabled', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'UserType' => 1, 'UserId' => 2, 'SessionId' => 3, 'SessionKey' => 4, 'Disabled' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'userType' => 1, 'userId' => 2, 'sessionId' => 3, 'sessionKey' => 4, 'disabled' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(LoginSessionTableMap::COL_ID => 0, LoginSessionTableMap::COL_USER_TYPE => 1, LoginSessionTableMap::COL_USER_ID => 2, LoginSessionTableMap::COL_SESSION_ID => 3, LoginSessionTableMap::COL_SESSION_KEY => 4, LoginSessionTableMap::COL_DISABLED => 5, LoginSessionTableMap::COL_CREATED_AT => 6, LoginSessionTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'user_type' => 1, 'user_id' => 2, 'session_id' => 3, 'session_key' => 4, 'disabled' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    {
        // attributes
        $this->setName('login_session');
        $this->setPhpName('LoginSession');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\LoginSession');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('user_type', 'UserType', 'VARCHAR', true, 255, null);
        $this->addColumn('user_id', 'UserId', 'INTEGER', true, null, null);
        $this->addColumn('session_id', 'SessionId', 'VARCHAR', true, 255, null);
        $this->addColumn('session_key', 'SessionKey', 'VARCHAR', true, 255, null);
        $this->addColumn('disabled', 'Disabled', 'BOOLEAN', true, 1, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LoginSessionTableMap::COL_USER_TYPE);
            $criteria->addSelectColumn(LoginSessionTableMap::COL_USER_ID);
            $criteria->addSelectColumn(LoginSessionTableMap::COL_SESSION_ID);
            $criteria->addSelectColumn(LoginSessionTableMap::COL_SESSION_KEY);
            $criteria->addSelectColumn(LoginSessionTableMap::COL_DISABLED);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \LoginSession) { // it's a model object
